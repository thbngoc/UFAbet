...
//			private static Alert homePage_Alert = null;
			...
			public static WebElement lnk_Soccer(WebDriver driver){
				...
				Utility.waitForElement(driver, "xpath", "//*[@id='key-soccer']/li[1]/a/span", utilities.Constant.pollingValue,utilities.Constant.timedOutVale );
			...
			public static WebElement lnk_OddEvenTotalGoal(WebDriver driver){
				...
				Utility.waitForElement(driver, "xpath", "//*[@id='soccer-oddEvenTotalGoal']/a", utilities.Constant.pollingValue,utilities.Constant.timedOutVale );
			...
			public static WebElement lnk_OddValue(WebDriver driver){
				...
				Utility.waitForElement(driver, "xpath", "//*[@id=\\\"mount\\\"]/div/main/div/div/article/div[2]/table/tbody/tr[2]/td[4]/div/span", utilities.Constant.pollingValue,utilities.Constant.timedOutVale );
			...
			public static WebElement txt_Amount(WebDriver driver){
				...
				Utility.waitForElement(driver, "xpath", "//*[@id='amount']", utilities.Constant.pollingValue,utilities.Constant.timedOutVale );
			...
			public static WebElement btn_ProcessBet(WebDriver driver){
				...
				Utility.waitForElement(driver, "linkText", "Process Bet", utilities.Constant.pollingValue,utilities.Constant.timedOutVale );
...
//			    }
			public static WebElement lbl_MaxPayout(WebDriver driver){
				...
				Utility.waitForElement(driver, "xpath", "//div[@class=\"bet-max-min margin-top-20\"]/div[2]", utilities.Constant.pollingValue,utilities.Constant.timedOutVale );
			...
			public static WebElement lbl_betRatio(WebDriver driver){
				...
				Utility.waitForElement(driver, "xpath", "//div[@class=\"bet-box\"]/div/span[2]", utilities.Constant.pollingValue,utilities.Constant.timedOutVale );
